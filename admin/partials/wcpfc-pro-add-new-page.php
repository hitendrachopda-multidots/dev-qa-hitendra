										...
										<div class="product_cost_right_div">
											<div class="applyperqty-boxone">
												<div class="applyperqty-box">
													<label for="fee_chk_qty_price"><?php esc_html_e( 'Apply Per Additional Quantity', 'woocommerce-conditional-product-fees-for-checkout' ); ?>
														<?php echo wp_kses( wc_help_tip( esc_html__( 'This will apply fees as per the quantity of products.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
													</label>
											...
											<div class="applyperqty-boxtwo">
												<div class="applyperqty-box">
													<label for="apply_per_qty_type"><?php esc_html_e( 'Calculate Quantity Based On', 'woocommerce-conditional-product-fees-for-checkout' ); ?>
														<?php echo wp_kses( wc_help_tip( esc_html__( 'Cart based will apply to the total product\'s quantity in the cart and Product based will apply to the specific product\'s quantity in the cart.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
													</label>
											...
											<div class="applyperqty-boxthree">
												<div class="applyperqty-box">
			                                        ...
			                                        <span class="required-star">*</span>
			                                        <?php echo wp_kses( wc_help_tip( esc_html__( 'You can add a fee here to be charged for each additional quantity.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span' => $allowed_tooltip_html ) ); ?>
			                                    </label>
									...
									<tr valign="top" class="wcpffc_advanced_setting_section">
				                        <th class="titledesc" scope="row">
				                            <label for="fee_settings_recurring">
				                                ...
				                                <?php echo sprintf( wp_kses( wc_help_tip( esc_html__( 'Once selected it will allow fees on recurring payments as well. %1$s %2$s %3$sNote: %4$sThis option only works with subscription products.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span'   => $allowed_tooltip_html,
				                                	'strong' => array(),
				                                	'br' 	 => array(),
				                                 ) ), '</br>', '</br>', '<strong>', '</strong>' ); ?>
				                            </label>
						...
						if ( wcpffc_fs()->is__premium_only() ) {
							if ( wcpffc_fs()->can_use_premium_code() ) {
			                    ...
			                    <tr valign="top" class="depend_of_custom_weight_base">
			                        ...
			                        <td class="forminp">
			                            <input type="text" name="sm_custom_weight_base_per_each" class="text-class" id="sm_custom_weight_base_per_each" value="<?php echo esc_attr( $sm_custom_weight_base_per_each ); ?>" placeholder="<?php esc_attr_e( $get_weight_unit, 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
			                        </td>
			                    </tr>
			                    <tr valign="top" class="depend_of_custom_weight_base">
			                        <th class="titledesc" scope="row">
			                        ...
			                        <td class="forminp">
			                            <input type="text" name="sm_custom_weight_base_over" class="text-class" id="sm_custom_weight_base_over" value="<?php echo esc_attr( $sm_custom_weight_base_over ); ?>" placeholder="<?php esc_attr_e( $get_weight_unit, 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
			                        </td>
			                    </tr>
								<tr valign="top">
									<th class="titledesc" scope="row">
		                    ...
		                    <tr valign="top">
		                        <th class="titledesc" scope="row">
		                            <label for="fee_settings_select_optional">
		                            	...
		                            	<?php echo sprintf( wp_kses( wc_help_tip( esc_html__( 'This will not apply fee by default. %1$s %2$s %3$sNote: %4$sOnce you select this optional fee to "Yes", It will always show the fee on checkout page as optional.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span'   => $allowed_tooltip_html,
			                                	'strong' => array(),
			                                	'br' 	 => array(),
			                                 ) ), '</br>', '</br>', '<strong>', '</strong>' ); ?>
		                            </label>
		                    ...
		                    <tr valign="top" class="enable_optional_checked">
		                        <th class="titledesc" scope="row">
		                            <label for="optional_fee_title">
		                                ...
		                                <?php echo sprintf( wp_kses( wc_help_tip( esc_html__( 'Set the optional fee section title that will display before the payment section on the checkout page. %1$s %2$s %3$sNote: %4$sWe are removing this field from upcoming update. From now you can change it by use of  "wcpfc_optional_fee_text" filter hook.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array( 'span'   => $allowed_tooltip_html,
			                                	'strong' => array(),
			                                	'br' 	 => array(),
			                                 ) ), '</br>', '</br>', '<strong>', '</strong>' ); ?>
		                            </label>
                                        ...
                                        <select rel-id="<?php echo esc_attr( $i ); ?>"
                                            ...
                                            <optgroup label="<?php esc_attr_e( 'Location Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
                                                ...
                                                if ( wcpffc_fs()->is__premium_only() ) {
                                                    if ( wcpffc_fs()->can_use_premium_code() ) {
                                                    	...
                                                    	?>
                                                        <option value="state_disabled" disabled><?php esc_html_e( 'State (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <option value="postcode_disabled" disabled><?php esc_html_e( 'Postcode (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <option value="zone_disabled" disabled><?php esc_html_e( 'Zone (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <?php
                                                    }
                                                } else {
                                                	?>
                                            ...
                                            <optgroup label="<?php esc_attr_e( 'Attribute Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
                                            	...
                                            	if ( wcpffc_fs()->is__premium_only() && wcpffc_fs()->can_use_premium_code() ) {
                                                	...
                                                	?>
                                                    <option value="attribute_list_disabled" disabled><?php esc_html_e( 'Color (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </optgroup>
                                            <optgroup label="<?php esc_attr_e( 'User Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
                                                ...
                                                if ( wcpffc_fs()->is__premium_only() ) {
                                                    if ( wcpffc_fs()->can_use_premium_code() ) {
                                                    	...
                                                    	?>
                                                        <option value="user_role_disabled" disabled><?php esc_html_e( 'User Role (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <?php
                                                    }
                                                } else {
                                                	?>
                                            ...
                                            <optgroup label="<?php esc_attr_e( 'Cart Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
                                                ...
                                                if ( wcpffc_fs()->is__premium_only() ) {
                                                    if ( wcpffc_fs()->can_use_premium_code() ) {
                                                    	...
                                                    	?>
                                                        <option value="cart_totalafter_disabled" disabled><?php esc_html_e( 'Cart Subtotal (After Discount) ', 'woocommerce-conditional-product-fees-for-checkout' ); ?><?php echo esc_html( $currency_symbol ); ?><?php echo esc_html( ' (In Pro)' ); ?></option>
                                                        <option value="cart_specificproduct_disabled" disabled><?php esc_html_e( 'Cart Subtotal (Specific products) ', 'woocommerce-conditional-product-fees-for-checkout' ); ?><?php echo esc_html( $currency_symbol ); ?><?php echo esc_html( ' (In Pro)' ); ?></option>
                                                        <?php
                                                    }
                                                } else {
                                                	?>
                                                ...
                                                if ( wcpffc_fs()->is__premium_only() ) {
                                                    if ( wcpffc_fs()->can_use_premium_code() ) {
                                                    	...
                                                    	?>
                                                        <option value="weight_disabled" disabled><?php esc_html_e( 'Weight ', 'woocommerce-conditional-product-fees-for-checkout' ); ?><?php echo esc_html( $weight_unit ); ?><?php echo esc_html( ' (In Pro)' );?></option>
                                                        <option value="coupon_disabled" disabled><?php esc_html_e( 'Coupon (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <option value="shipping_class_disabled" disabled><?php esc_html_e( 'Shipping Class (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
                                                        <?php
                                                    }
                                                } else {
                                                	?>
                                            ...
                                            <optgroup label="<?php esc_attr_e( 'Payment Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
	                                            ...
	                                            if ( wcpffc_fs()->is__premium_only() ) {
	                                                if ( wcpffc_fs()->can_use_premium_code() ) {
	                                                	...
	                                                	?>
	                                                	<option value="payment_disabled" disabled><?php esc_html_e( 'Payment Gateway (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
	                                                	<?php
	                                                }
	                                            } else {
                                                	?>
                                        	...
                                        	<optgroup label="<?php esc_attr_e( 'Shipping Specific', 'woocommerce-conditional-product-fees-for-checkout' ); ?>">
	                                            ...
	                                            if ( wcpffc_fs()->is__premium_only() ) {
	                                                if ( wcpffc_fs()->can_use_premium_code() ) {
	                                                	...
	                                                	?>
	                                                    <option value="shipping_method_disabled" disabled><?php esc_html_e( 'Shipping Method (In Pro)', 'woocommerce-conditional-product-fees-for-checkout' ); ?></option>
	                                                    <?php
	                                                }
	                                            } else {
                                                	?>
                                        ...
                                        if ( wcpffc_fs()->is__premium_only() ) {
                                            if ( wcpffc_fs()->can_use_premium_code() ) {
                                                if ( 'country' === $fees_conditions ) {
                                                    ...
                                                    $html .= '<input type="text" name="fees[product_fees_conditions_values][value_' . $i . ']" id="product_fees_conditions_values" class="product_fees_conditions_values price-class" value="' . $condtion_value . '">';
                                                    $html .= sprintf( wp_kses( __( '<p><b style="color: red;">Note: </b>This rule will apply when you would apply coupon on front side. <a href="%s" target="_blank">Click Here</a></p>', 'woocommerce-conditional-product-fees-for-checkout' ), array(
                                                                'p' => array(),
                                                                'b' => array( 'style' => array() ),
                                                                'a' => array( 'href' => array(), 'target' => array() ),
                                                            ) )
