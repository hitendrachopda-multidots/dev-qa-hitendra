		...
		<div class="wcpfc-main-table res-cl">
			...
			<table class="table-outer">
				...
				<tr>
					...
					<td class="fr-2"><a target="_blank" href="<?php echo esc_url( "https://www.thedotstore.com/terms-and-conditions/" ); ?>"><?php esc_html_e( 'Click here', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a><?php esc_html_e( ' to view license and terms of use.', 'woocommerce-conditional-product-fees-for-checkout' ); ?>
					</td>
				</tr>
				<tr>
					...
					<td class="fr-2">
						<ul style="margin: 0px;">
							<li><a target="_blank" href="<?php echo esc_url( add_query_arg( array( 'page' => 'wcpfc-pro-get-started' ), admin_url( 'admin.php' ) ) ); ?>"><?php esc_html_e( 'Quick Start', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
							<li><a target="_blank" href="<?php echo esc_url( "https://docs.thedotstore.com/category/191-premium-plugin-settings" ); ?>"><?php esc_html_e( 'Guide Documentation', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
							<li><a target="_blank" href="<?php echo esc_url( "https://www.thedotstore.com/support" ); ?>"><?php esc_html_e( 'Support Forum', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
                            <li><a target="_blank" href="<?php echo esc_url( "https://docs.thedotstore.com/article/672-custom-filters" ); ?>"><?php esc_html_e( 'Custom Filters', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
						</ul>
					</td>
				</tr>
