module.exports = function(grunt){
    ...
    var SOURCE_DIR = './', //root path of plugin folder
        ZIP_FILE_NAME = 'woocommerce-conditional-product-fees-for-checkout.zip', //add name of final zip
        BKP_FILE_SGGESTION = "(backup|bkp)", //add multiple back up file slug here to remove from plugin before making zip
        TEXT_DOMAIN = ['woocommerce-conditional-product-fees-for-checkout'], //list out textdomain for check in whole plguin files
        PLUGIN_MAIN_FILE = 'woocommerce-conditional-product-fees-for-checkout.php', //write down main file name of plugin
        POT_FILE_NAME = 'woocommerce-conditional-product-fees-for-checkout.pot', //write down POT file name
    ...
    grunt.initConfig({
        ...
        compress: {
            main: {
                ...
                files: [{
                    src: ['**', '!**/node_modules/**', '!**/vendor/**', '!**/Gruntfile.js', '!**/ruleset.xml', '!**/composer.json', '!**/composer.lock', '!**/package-lock.json', '!**/package.json', '!**/*.zip', '!**/phpcs_report.txt', '!**/phpcs.xml' ], 
                    dest: '.'
                }]
            }
        },
        ...
        jsvalidate: {
            ...
            src: [ '**/*.js', '!**/freemius/**', '!**/node_modules/**', '!**/chart.js', '!**/vendor/**', '!**/*.min.js', '!**/Gruntfile.js', '!**/jquery.*.js'],
        },
        ...
        jshint: {
            ...
            src: [ '**/*.js', '!**/freemius/**', '!**/node_modules/**', '!**/vendor/**', '!**/chart.js', '!**/*.min.js', '!**/Gruntfile.js', '!**/jquery.*.js']
        }
